...
describe("Api versioning", function () {
  ...
  it("should fail with invalid versions", function () {
    ...
    expectToThrow(doc.verifyApiVersion.bind(null, "3.27.100"), Errors.XTAPIVersionError, {
...
describe("Changing the parser", function () {
  ...
  it("should be able to access meta to get the type of tag", function () {
    ...
    var values = contexts.map(function (_ref6) {
      var _ref6$meta$part = _ref6.meta.part,
          type = _ref6$meta$part.type,
          value = _ref6$meta$part.value,
          module = _ref6$meta$part.module;
      return {
        type: type,
        value: value,
        module: module
