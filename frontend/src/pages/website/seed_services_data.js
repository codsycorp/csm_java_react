...
const serviceCategories = [
  ...
  },
  {
    ...
    category_en: "Tools",
    category_zh: "工具",
    image: `https://www.${DOMAIN}/app_images/services/cong-cu-og.jpg`,
    attributes_icon: "ToolOutlined",
    attributes_color: "#f50",
    attributes_priority: 0,
    attributes_title: "Công Cụ - Giải Pháp Hỗ Trợ",
    attributes_title_en: "Tools - Support Solutions",
    attributes_title_zh: "工具 - 支持解决方案",
    attributes_keywords: "công cụ hỗ trợ, giải pháp công cụ, phần mềm tiện ích.",
    attributes_keywords_en: "support tools, tool solutions, utility software.",
    attributes_keywords_zh: "支持工具、工具解决方案、实用软件。",
    attributes_description: "Khám phá các công cụ hỗ trợ và giải pháp công cụ tiện ích.",
    attributes_description_en: "Discover support tools and tool solutions.",
    attributes_description_zh: "发现支持工具和工具解决方案。"
  },
  {
    id:"xem-ngay",
  ...
  },
  {
    ...
    is_group_slug: false,
    is_group_slug_default: false,
    category: "Kết Quả Xuất Sắc",
    category_en: "Results",
    category_zh: "结果",
    image: `https://www.${DOMAIN}/app_images/services/kqxs-og.jpg`,
    attributes_icon: "BarChartOutlined",
    attributes_color: "#faad14",
    attributes_priority: 0,
    attributes_title: "Kết Quả Xuất Sắc - Thống Kê Kết Quả",
    attributes_title_en: "Results - Result Statistics",
    attributes_title_zh: "结果 - 结果统计",
    attributes_keywords: "kết quả xuất sắc, thống kê kết quả, phân tích dữ liệu.",
    attributes_keywords_en: "outstanding results, result statistics, data analysis.",
    attributes_keywords_zh: "杰出成果、结果统计、数据分析。",
    attributes_description: "Thống kê kết quả xuất sắc, phân tích dữ liệu.",
    attributes_description_en: "Outstanding result statistics, data analysis.",
    attributes_description_zh: "杰出结果统计，数据分析。"
  }
