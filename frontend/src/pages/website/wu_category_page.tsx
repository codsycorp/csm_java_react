...
import WuDynamicMenuPage from './wu_dynamic_menu_page';
...
export default function WuCategoryPage() {
  ...
  // Non-service: choose between dynamic-code content and empty-state page
  const dynamicCode = String(catObj.dynamic_code_name || catObj.dynamicCodeName || '').trim();
  return dynamicCode ? <WuDynamicMenuPage /> : <WuNoContentPage />;
}
