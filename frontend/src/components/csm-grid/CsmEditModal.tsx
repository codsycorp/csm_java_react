    ...
    function ImageField() {
      ...
      return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          {imageUrl && <img src={imageUrl} alt="Ảnh" style={{ maxWidth: 100, maxHeight: 100, borderRadius: 8, border: '1px solid #eee' }} />}
          <Suspense fallback={<span>Đang tải...</span>}>
            <MediaUploader value={imageUrl} onChange={handleImageChange} />
          </Suspense>
        </div>
      );
    }
