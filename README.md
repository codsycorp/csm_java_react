...
sudo certbot --nginx   -d phanmemmottrieu.net -d www.phanmemmottrieu.net -d api.phanmemmottrieu.net -d php.phanmemmottrieu.net -d kqxs.phanmemmottrieu.net -d tanphuice.com -d www.tanphuice.com -d nuocdatanphu.com -d www.nuocdatanphu.com -d phanmemmottrieu.net -d h-holding.vn -d www.h-holding.vn -d h-holding.com.vn -d www.h-holding.com.vn -d csmbridge.net -d www.csmbridge.net -d api.csmbridge.net -d realtime.csmbridge.net -d kqxs.csmbridge.net -d php.csmbridge.net
