...
export default function App() {
	...
	useEffect(() => {
		// lmkt không có đăng nhập nên không cho xóa tin nhắn; giữ API nhưng no-op để tránh lỗi TS
		(window as any).deleteChatMessage = async (_timestamp: number) => {
			console.warn("deleteChatMessage is disabled on lmkt (no auth)");
