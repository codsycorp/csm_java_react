...
export const PHUSON_PANEL_CONFIG: LineItemsEditorConfig = {
  ...
  table: [
    { f_name: "so_lenh",       f_header: "Số lệnh SX",       f_types: "text",   f_show: 1, f_stt: 1,  f_width_col: 8 },
    { f_name: "so_bao_gia",    f_header: "Số báo giá",        f_types: "text",   f_show: 1, f_stt: 2,  f_width_col: 8 },
    { f_name: "ngay",          f_header: "Ngày lập",          f_types: "text",   f_show: 1, f_stt: 3,  f_width_col: 4, f_placeholder: "09/06/2026" },
    { f_name: "hieu_luc_den",  f_header: "Hiệu lực đến",      f_types: "text",   f_show: 1, f_stt: 4,  f_width_col: 4, f_placeholder: "14/06/2026" },
    { f_name: "khach_hang",    f_header: "Tên khách hàng",    f_types: "text",   f_show: 1, f_stt: 5,  f_width_col: 12 },
    { f_name: "dia_chi_kh",    f_header: "Địa chỉ KH",        f_types: "text",   f_show: 1, f_stt: 6,  f_width_col: 12 },
    { f_name: "nguoi_lien_he", f_header: "Người liên hệ",     f_types: "text",   f_show: 1, f_stt: 7,  f_width_col: 12, f_placeholder: "Mr Thành - 0982476556" },
    { f_name: "nvkd",          f_header: "NVKD",              f_types: "text",   f_show: 1, f_stt: 8,  f_width_col: 12, f_placeholder: "Mr Long - 0978349917" },
    { f_name: "phi_vc",        f_header: "Vận chuyển",        f_types: "select", f_show: 1, f_stt: 9,  f_width_col: 10,
